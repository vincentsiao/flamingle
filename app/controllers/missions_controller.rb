class MissionsController < ApplicationController
  ...
  def accept
    MissionAttempt.create(:user_id => current_user.id, :mission_id => params[:id], :status => 'Attempting')
    flash[:notice] = "You're now attempting '" + Mission.find(params[:id]).title + "'. Good Luck!"
